 ...
 */
function theme_config_sciglobe()
{
    return array(
        'image_type' => 'png',
        'doctype'    => 'xhtml5',
        ...
        'theme_plugins' => 'sciglobe', // Not requred, you can specify compatible theme of template stored with some plugins
 ...
 */
function theme_js_libs_sciglobe()
{
    return array(
       array(
            'library' => 'jquery',
 ...
 */
function theme_js_files_sciglobe()
{
    global $_CONF;

    $theme_var = theme_config_sciglobe();
