...
function theme_css_fotos()
{
    ...
    return array(
        array('file' => '/vendor/uikit/css' . $direction . '/uikit.almost-flat.css', 'attributes' => array('media' => 'all'), 'priority' => 80),
        array('file' => '/layout/' . $_CONF['theme'] . '/css_' . $LANG_DIRECTION . '/theme.css', 'priority' => 90),
        array('file'       => '/layout/' . $_CONF['theme'] . '/css_' . $LANG_DIRECTION . '/add_to_uikit.css',  'priority' => 100),
        array('file' => '/layout/' . $_CONF['theme'] . '/css_' . $LANG_DIRECTION . '/style.css', 'priority' => 110),
    );
}
