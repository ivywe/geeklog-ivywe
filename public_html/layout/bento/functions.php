...
function theme_css_bento()
{
    ...
    return array(
        array(
            'name'       => 'uikit',
            'file'       => '/vendor/uikit/css' . $direction . '/uikit.css',
        ...
        array(
            ...
            'file'       => '/layout/' . $_CONF['theme'] . '/css_' . $LANG_DIRECTION . '/theme.css', // change '/theme.css'
            'attributes' => array('media' => 'all'),
            'priority'   => 120
        )
    );
