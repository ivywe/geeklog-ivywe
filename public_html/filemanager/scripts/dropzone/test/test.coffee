    ...
    describe "uploadFiles()", ->
      ...
      it "should include hidden files in the form and unchecked checkboxes and radiobuttons should be excluded", (done) ->
        element = Dropzone.createElement """<form action="/the/url">
                                              ...
                                              <input type="radio" class="uk-radio" value="radiovalue1" name="radio1" />
                                              <input type="radio" class="uk-radio" value="radiovalue2" name="radio1" checked="checked" />
                                              <select class="uk-select" name="select"><option value="1">1</option><option value="2" selected>2</option></select>
                                            </form>"""
        dropzone = new Dropzone element, url: "/the/url"
      ...
      it "should all values of a select that has the multiple attribute", (done) ->
        element = Dropzone.createElement """<form action="/the/url">
                                              <select class="uk-select" name="select" multiple>
