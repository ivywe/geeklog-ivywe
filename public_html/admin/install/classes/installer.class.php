...
class Installer
{
    ...
    private function migrateStep1()
    {
        ...
        $display .= '<h2>' . $LANG_INSTALL[31] . '</h2>' . PHP_EOL
            ...
            . '<div class="uk-form-row"><label class="uk-form-label">' . $LANG_INSTALL[34] . ' ' . $this->getHelpLink('db_type') . '</label> <div class="uk-form-controls"><select class="uk-select uk-form-width-medium" name="db[type]">' . PHP_EOL
        ...
        $display .= '<div class="uk-form-row"><label class="uk-form-label">'
            ...
            . '</label>' . PHP_EOL
            . '<div class="uk-form-controls"><select class="uk-select uk-form-width-medium" name="migration_type" onchange="INST_selectMigrationType()">' . PHP_EOL
        ...
        if (count($backupFiles) > 0) {
            $display .= '<select class="uk-select uk-form-width-medium" name="backup_file">' . PHP_EOL
