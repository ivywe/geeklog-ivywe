...
$LANG_PAYPAL_1 = array(
    ...
    'details'                 => '詳細を表示する',
    'payment_method'          => 'ご注文内容の確認メールが送付されます。請求書は商品に同梱または別送します。', //他のgatewayを使う場合、ここは「ご希望の支払方法を選んでください」
    'checkout_step_1'         => 'Step 1.<br>購入商品の確認',
    'checkout_step_2'         => 'Step 2.<br>購入者情報の入力',
    'checkout_step_3'         => 'Step 3.<br>注文内容の確認', // 注文内容の確定
	...
	'confirm_order_button'    => '注文を確定する',
	'confirm_order_check'     => '以下の項目を入力して「注文を確定する」をクリックすればご請求のメールが送付されます。',
	'review_details'          => '送付先（請求先）情報を入力してください',
	'order_received'          => 'ご注文は確定していません。', // ご注文が確定しました。
	'confirm_by_email'        => 'メールでのお振込連絡により注文が確定します。', // 
...
$LANG_PAYPAL_CART = array(
	...
	'payment_check'           => 'Step 2.購入者情報の入力へすすむ',
	'total'                   => '合計',
	'free_shipping'           => '送料無料',
