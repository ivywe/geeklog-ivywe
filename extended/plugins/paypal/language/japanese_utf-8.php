...
$LANG_PAYPAL_1 = array(
    ...
    'details'                 => '詳細',
    'payment_method'          => '銀行振り込みまたはPayPal・カード決済を選んでレジに進んでください。',
    ...
    'logged_to_purchase'      => 'この商品購入はログインが必要？',
    'or'                      => '｜',
    ...
    'proid'                   => 'お振込み予定日',
    'edit_details'            => 'お届け先住所',
    'edit_user_details'       => 'お届け先住所を編集する',
    'editing_user_details'    => 'お届け先住所',
	...
	'confirm_order_check'     => 'ご注文内容の確認メールをお送りします。お振込みご連絡後、通常2営業日以内に商品を発送させていただきます。',
	'review_details'          => 'お届け先住所を入力してください',
	'order_received'          => 'ご注文ありがとうございます。メールを送信しました。', 
...
$LANG_PAYPAL_CART = array(
    ...
    'update'                  => '再計算',
    'checkout'                => 'チェックアウト',
    'paypal_checkout'         => 'レジに進む（PayPal・カード決済）',
    'remove'                  => '取消す',
    'empty'                   => 'クリア',
