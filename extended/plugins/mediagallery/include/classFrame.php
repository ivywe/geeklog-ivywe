...
class mgFrame {
    ...
    function constructor ( $name ) {
        ...
        $this->frame['imageTL']   = '';
        $this->frame['widthTL']   = 0;
        $this->frame['heightTL']  = 0;
        $this->frame['imageTTL']  = '';
        $this->frame['widthTTL']  = 0;
        $this->frame['imageTT']   = '';
        $this->frame['heightTT']  = 0;
        $this->frame['imageTTR']  = '';
        $this->frame['widthTTR']  = 0;
        $this->frame['imageTR']   = '';
        $this->frame['widthTR']   = 0;
        $this->frame['heightTR']  = 0;
        $this->frame['imageLLT']  = '';
        $this->frame['heightLLT'] = 0;
        $this->frame['imageLL']   = '';
        $this->frame['widthLL']   = 0;
        $this->frame['imageLLB']  = '';
        $this->frame['heightLLB'] = 0;
        $this->frame['imageRRT']  = '';
        $this->frame['heightRRT'] = 0;
        $this->frame['imageRR']   = '';
        $this->frame['widthRR']   = 0;
        $this->frame['imageRRB']  = '';
        $this->frame['heightRRB'] = 0;
        $this->frame['imageBL']   = '';
        $this->frame['widthBL']   = 0;
        $this->frame['heightBL']  = 0;
        $this->frame['imageBBL']  = '';
        $this->frame['widthBBL']  = 0;
        $this->frame['imageBB']   = '';
        $this->frame['heightBB']  = 0;
        $this->frame['imageBBR']  = '';
        $this->frame['widthBBR']  = 0;
        $this->frame['imageBR']   = '';
        $this->frame['widthBR']   = 0;
        $this->frame['heightBR']  = 0;
...
/*------------------------------------------------------------------------------------------------------------------*/
            ...
            if (file_exists($_MG_CONF['path_html'] . 'frames/' . $this->name . '/frame.thtml')) {
                return file_get_contents($_MG_CONF['path_html'] . 'frames/' . $this->name . '/frame.thtml');
            }

/*------------------------------------------------------------------------------------------------------------------*/
            if ( $this->name == 'mgShadow' || $this->name == '' ) {
                $retval = '<div class="out" style="margin:0 auto; width:{border_width}px;">' . LB; // modified style
            ...
            $retval = '<div style="text-align:center;width:100%;">' . LB;
...
/*------------------------------------------------------------------------------------------------------------------*/
        if (file_exists($_MG_CONF['path_html'] . 'frames/' . $this->name . '/style.css')) {
            return '<link rel="stylesheet" type="text/css" href="' . $_MG_CONF['site_url'] . '/frames/' . $this->name . '/style.css"' . XHTML . '>' . LB;
        }
/*------------------------------------------------------------------------------------------------------------------*/
        ...
        $retval .= 'table.mgFrame_' . $this->name . ' { direction: ltr; display: inline-block; }' . LB; // modified style
