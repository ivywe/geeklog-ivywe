...
function MG_editAlbum($mode ='', $actionURL='', $oldaid = 0)
{
    ...
    $valid_albums = 0;
    $album_selectbox  = '<select class="uk-select" name="parentaid">';
...
//          '8' => $LANG_MG03['sort_rating_asc'],
    ...
    if (SEC_hasRights('mediagallery.admin')) {
        ...
        $featurepage_select = '<select class="uk-select" name="featurepage">';
    ...
    $result = DB_query($sql);
    $nRows  = DB_numRows($result);
    $wm_select =  '<select class="uk-select" name="wm_id" onchange="change(this)">';
