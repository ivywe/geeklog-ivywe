...
//    $album_selectbox  = MG_buildAlbumBox($root_album, $album_id, 3, -1, 'upload');
    ...
    $album_selectbox  = '<select class="uk-select uk-form-width-medium" name="' . $dest . '">' . LB;
    $root_album = new mgAlbum(0);
    $root_album->buildAlbumBox($album_selectbox, $album_id, 3, -1, 'upload');
    ...
    while (($file = readdir($dh)) != false) {
        ...
        $T->set_var(array(
            ...
            'parent_select' => '<select class="uk-select uk-form-width-medium" name="parentaid">' . LB . $album_selectbox,
...
function MG_FTPpickFiles($album_id, $dir, $purgefiles, $recurse)
{
    ...
    $album_jumpbox  = '<select class="uk-select uk-form-width-medium" name="parentaid">';
