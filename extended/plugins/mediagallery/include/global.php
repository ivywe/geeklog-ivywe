...
function MG_globalAlbumAttributeEditor($adminMenu=0)
{
    ...
    $exif_select  = '<select class="uk-select uk-form-width-medium" name="enable_exif">';
    ...
    $full_select  = '<select class="uk-select uk-form-width-medium" name="full_display">';
    ...
    $ranking_select = '<select class="uk-select uk-form-width-medium" name="enable_rating">';
    ...
    $podcast_select = '<input type="checkbox" class="uk-checkbox" name="podcast" value="1" ' . ($A['podcast'] ? ' checked="checked"' : '') . XHTML .  '>';
    $mp3ribbon_select = '<input type="checkbox" class="uk-checkbox" name="mp3ribbon" value="1" ' . ($A['mp3ribbon'] ? ' checked="checked"' : '') . XHTML . '>';
    $rsschildren_select = '<input type="checkbox" class="uk-checkbox" name="rsschildren" value="1" ' . ($A['rsschildren'] ? ' checked="checked"' : '') . XHTML . '>';
    ...
    $ss_select      = '<select class="uk-select uk-form-width-medium" name="enable_slideshow">';
    ...
    $ri_select      = '<input type="checkbox" class="uk-checkbox" name="enable_random" value="1"' . XHTML . '>';
    $views_select   = '<input type="checkbox" class="uk-checkbox" name="enable_views" value="1"' . XHTML . '>';
    $keywords_select = '<input type="checkbox" class="uk-checkbox" name="enable_keywords" value="1"' . XHTML . '>';
    $sort_select    = '<input type="checkbox" class="uk-checkbox" name="enable_sort" value="1"' . XHTML . '>';
    ...
    $tn_size_select  = '<select class="uk-select uk-form-width-medium" name="tn_size">';
    ...
    $tnheight_input = '<input type="text" class="uk-input uk-form-width-small" size="3" name="tnheight" value=""' . XHTML . '>';
    $tnwidth_input  = '<input type="text" class="uk-input uk-form-width-small" size="3" name="tnwidth" value=""' . XHTML . '>';

    $display_image_size_select  = '<select class="uk-select uk-form-width-medium" name="display_image_size">';
    ...
    $rows_input      = '<input type="text" class="uk-input uk-form-width-xsmall" size="3" name="display_rows" value="' . $_MG_CONF['album_display_rows'] . '"' . XHTML . '>';
    $columns_input   = '<input type="text" class="uk-input uk-form-width-xsmall" size="3" name="display_columns" value="' . $_MG_CONF['album_display_columns'] . '"' . XHTML . '>';

    $playback_type  = '<select class="uk-select uk-form-width-medium" name="playback_type">';
    ...
    $rss_select     = '<input type="checkbox" class="uk-checkbox" name="enable_rss" value="1"' . XHTML . '>';
    $display_album_desc_select     = '<input type="checkbox" class="uk-checkbox" name="display_album_desc" value="1"' . XHTML . '>';

    $allow_download_select     = '<input type="checkbox" class="uk-checkbox" name="allow_download" value="1"' . XHTML . '>';

    // build album list for starting point...

    $album_jumpbox  = '<select class="uk-select uk-form-width-medium" name="startaid">';
    ...
    $skins = MG_getFrames();
    $skin_select  = '<select class="uk-select uk-form-width-medium" name="skin">';
    $askin_select = '<select class="uk-select uk-form-width-medium" name="askin">';
    $dskin_select = '<select class="uk-select uk-form-width-medium" name="dskin">';
