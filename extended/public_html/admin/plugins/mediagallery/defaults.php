...
// +--------------------------------------------------------------------------+
// | $Id:: defaults.php 5847 2010-04-09 13:16:50Z mevans0263                 $|
...
function MG_editDefaults( ) {
    ...
    if ( !isset($_MG_CONF['ad_group_id'] ) ) {
        $_MG_CONF['ad_group_id'] = $default_group_id;
    }
...
function MG_saveDefaults( ) {
    ...
    $group_id               = COM_applyFilter($_POST['group_id'],true); // added
...
--- */
    ...
    DB_save($_TABLES['mg_config'],"config_name, config_value","'ad_group_id','$group_id'"); // added
