...
// +--------------------------------------------------------------------------+
// | $Id:: upgrade.php 6036 2010-04-24 04:13:14Z mevans0263                  $|
// +--------------------------------------------------------------------------+
...
//            }
        ...
        case "1.6.11" :
            if ( MG_upgrade_1612() == 0 ) {
                DB_query("UPDATE {$_TABLES['plugins']} SET pi_version='1.6.12' WHERE pi_name='mediagallery' LIMIT 1");
            }
        ...
        default :
            ...
            DB_query("UPDATE {$_TABLES['plugins']} SET pi_homepage='".$_MG_CONF['pi_url']."' WHERE pi_name='mediagallery'",1);
