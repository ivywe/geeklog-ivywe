        ...
        switch ( $session['session_action'] ) {
            ...
            case 'rebuildthumb' :
                ...
                if ( $mimeType == 'image/x-targa' ||
                    ...
                    list($rc,$msg) = MG_resizeImage($tmpImage, $imageThumb, $tnHeight, $tnWidth, $mimeType, 0, $_MG_CONF['tn_jpg_quality']);
                } else {
                ...
                $cropSize = 150; // 150px
                if ( $tmpImage != '' ) {
                    list($rc,$msg) = MG_resizeImage_crop($tmpImage, $imageThumb_crop, $cropSize, $cropSize, $mimeType, 0, $_MG_CONF['tn_jpg_quality']);
                } else {
            ...
            case 'rebuilddisplay' :
                ...
                if ( $tmpImage != '' ) {
                    list($rc,$msg) = MG_resizeImage($tmpImage, $imageDisplay, $dImageHeight, $dImageWidth, $mimeType, 0, $_MG_CONF['jpg_quality']);
                } else {
