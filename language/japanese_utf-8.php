...
$LANG01 = array(
    ...
    57 => 'パスワード',
    58 => 'ログイン',
    59 => "<a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\"><i class=\"uk-icon-sign-in\"></i> 新規登録</a>",
    60 => 'コメントの投稿',
    61 => 'アカウントの登録',
    62 => 'ワード',
    63 => 'コメントの設定',
    ...
    117 => '記事一覧',
    118 => '続きのページへ:',
    119 => "<a href=\"{$_CONF['site_url']}/users.php?mode=getpassword\" rel=\"nofollow\"><i class=\"uk-icon-exclamation-circle\"></i> お困りですか？</a>",
    120 => 'このコメントへのパーマリンク',
    121 => 'コメント (%d件)',
    122 => 'トラックバック (%d件)',
    123 => 'すべてのHTMLを許可。',
...
$LANG04 = array(
    ...
    25 => '<i class="uk-icon-exclamation-circle"></i> お困りですか？</a>',
    ...
    91 => '再設定',
    92 => 'パスワードの再設定',
    93 => 'パスワード再設定は%d秒前に行われています。パスワードの再設定は少なくとも%d秒間隔を空けてください。',
    94 => 'アカウント("%s")を削除',
    95 => 'あなたのアカウントを削除するには、下の「アカウント削除」ボタンをクリックしてください。ただし、あなたのアカウント名で投稿した記事やコメントは<strong>削除はしません</strong>。これらの記事やコメントは「ゲストユーザー」の投稿として表示するようになります。',
    96 => 'アカウント削除',
    97 => 'アカウント削除の確認',
    ...
    123 => "<a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\"><i class=\"uk-icon-sign-in\"></i> 新規登録</a>",
    124 => '(確認)メールアドレス',
...
$LANG12 = array(
    ...
    2 => 'ログイン',
    3 => '<i class="uk-icon-sign-in"></i> 新規登録',
    4 => '',
    5 => '',
    6 => '記事の投稿',
    7 => 'ログインが必要です',
...
$LANG21 = array(
    ...
    69 => 'プラグイン名',
    'cache_time' => 'キャッシュ期間',
    'cache_time_desc' => 'このブロックは指定した秒数の間キャッシュされます。0を指定するとキャッシュしません。-1を指定するとブロックを編集しない限りキャッシュしません。(3600 = 1時間、86400 = 1日)'
);
...
$LANG24 = array(
    ...
    'cache_time' => 'キャッシュ期間',
    'cache_time_desc' => 'この記事は指定した秒数の間キャッシュされます。0を指定するとキャッシュしません。-1を指定すると記事を編集しない限りキャッシュしません。(3600 = 1時間、86400 = 1日)'
);
...
$LANG27 = array(
    ...
    42 => '継承の欄は割り当てられている話題のリストを含んでいます。話題を選択すると、親の話題を継承します。',
...
$LANG_404 = array(
    ...
    4 => "<p>リクエストしたページは見つかりません。<a href=\"%s\">関連ページ</a>に戻るか、<a href=\"{$_CONF['site_url']}/\">ホームページ</a>に戻る、あるいは<a href=\"{$_CONF['site_url']}/search.php\">検索ページ</a>で目的のページを探してください。"
);
...
$LANG_LOGIN = array(
    ...
    2 => '先にログインしてください。',
    3 => 'ログイン',
    4 => '<i class="uk-icon-users"></i> 新規登録'
);
...
$LANG_configselects['Core'] = array(
    ...
    2 => array('拒否する' => 0, '最後に送信したものだけ保持する' => 1, '複数送信を許可する' => 2),
