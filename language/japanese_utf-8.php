...
$LANG03 = array(
    ...
    4 => 'アカウントを作成',
    5 => 'ユーザー名',
    6 => 'コメントの投稿の前にサインインしてください。アカウントを登録していなければ、下のフォームで登録してください。',
    7 => 'あなたは',
    ...
    105 => 'IPアドレス', 
    106 => 'コメントとコメントの投稿に対して、ユーザーまたはIPアドレスの承認、削除、および禁止の一括処理を実行します。'
);
...
$LANG04 = array(
    ...
    23 => "{$_CONF['site_name']}にユーザーアカウントを登録すると、銀行振り込みによる商品を購入可能になります。",
    ...
    61 => '順番',
    62 => 'デフォルトは100件です',
    63 => "パスワードをメールで送信しました。サインイン方法をご案内しています。{$_CONF['site_name']}のご利用をお待ちしています。",
    64 => 'コメントの設定:',
    65 => '再度サインインしてください',
    66 => 'サインインに失敗しました。再度サインインしてください。',
    67 => '登録日時',
    68 => '認証の保存期間',
    69 => 'いったんサインインした後、どのくらいの間認証情報を残しますか?',
    70 => "{$_CONF['site_name']}の表示と内容を設定",
    71 => "{$_CONF['site_name']}では、レイアウトを自由に変えることができます。そのためには、{$_CONF['site_name']}に<a href=\"{$_CONF['site_url']}/users.php?mode=new\" rel=\"nofollow\">登録</a>する必要があります。もし、既に登録済みなら左のフォームを利用してサインインしてください。",
    72 => 'テーマ',
    73 => '言語',
    74 => 'このサイトのデザインを変更',
    ...
    96 => 'アカウント削除',
    97 => 'アカウント削除の確認',
    98 => '本当にアカウントを削除しますか。削除すると、このサイトに新しいアカウントを作らない限り、サインインできなくなります。よろしければ、もう一度「アカウント削除」ボタンをクリックしてください。',
    99 => 'プライバシーオプション:',
    100 => '管理者からのメール',
    ...
    112 => 'サインインの試行回数を超えました。後ほどまたサインインしてください。',
    113 => 'サインインできませんでした',
    114 => 'アカウントが無効です',
    115 => 'アカウントが無効になりましたのでサインインできません。管理者に連絡してください。',
    116 => 'アカウントが有効になるのを待機しています',
    117 => 'あなたのアカウントは管理者が有効にするのを待っています。管理者が承認するまでサインインできません。',
    118 => "{$_CONF['site_name']} のあなたのアカウントを有効にしました。以下のリンクから、あなたのユーザー名(<username>)とメールで送られてきたパスワードでサインインできます。",
    ...
    145 => '公開プロフィール',
    146 => 'パスワードとメールアドレス',
    147 => 'パスワード、メールアドレス、自動サインイン機能を編集します。パスワードとメールアドレスは確認のため、2回入力する必要があります。',
    148 => '個人情報',
    ...
    166 => 'リモートアカウントの再同期',
    167 => 'リモートサインイン',
    168 => 'リモート認証サービスによるサインインも可能です。',
    169 => 'ユーザーのプロファイル更新',
    'user_login' => 'ユーザーサインイン',
    'user_login_message' => 'サインインしてください。ユーザー名とパスワードの両方を入力してください。',
    'user_logged_in_message' => "すでにサインインしています。<a href=\"{$_CONF['site_url']}/users.php?mode=logout\" rel=\"nofollow\">ログアウト</a>しますか?"
);
...
$LANG_ENVCHECK = array(
    ...
    'openssl_ok' => 'OpenSSLがロードされています。このライブラリはOAuthを使用するユーザーがサインインするのに必要です。',
    'openssl_not_found' => 'OpenSSLライブラリがロードされていません。このライブラリはOAuthを使用するユーザーがサインインする場合に<strong>のみ</strong>必要です。',
    'off' => 'Off',
    'ok' => 'OK',
    'on' => 'On',
...
$LANG28 = array(
    ...
    51 => 'オンライン期間',
    52 => '<br' . XHTML . '>注: 「オンライン期間」とは、最初にアカウントを登録してから前回サインインした時までの日数です。',
    53 => '登録済み',
    54 => '一括削除',
    55 => 'この機能はコンフィギュレーションの管理パネルで「最終サインインを記録する」を有効に設定している場合にのみ動作します。',
    ...
    60 => '一度もサインインしていない、',
    61 => 'ヶ月以前に登録したユーザーです。',
    62 => '登録して24時間以内にサインインした後で一度もサインインしていない、',
    63 => 'ヶ月以前に登録したユーザーです。',
    64 => '通常のユーザーでサイトを、',
    ...
    75 => '最近',
    76 => 'ヶ月に登録したユーザーです。',
    77 => '選択したユーザーにサインインのリマインダーをメールで送信',
    78 => 'リマインダーを送信',
    ...
    84 => "あなたのサインイン名: %s  サイト名: {$_CONF['site_url']}",
...
$MESSAGE = array(
    1 => "パスワードをメールで送信しました。利用方法はメールを参照してください。{$_CONF['site_name']}",
    ...
    53 => '新しいパスワードを登録しました。この新しいパスワードを使ってサインインしてください。',
    ...
    81 => 'サインイン情報の入力が不正確だったようです。もう一度、サインインし直してください。',
    82 => 'サインインの試行回数を超えました。後ほどまたサインインしてください。',
    83 => 'パスワード、メールアドレス、認証の保存期間を変更するには現在のパスワードを入力してください。',
    84 => 'アカウントを削除するには現在のパスワードを入力してください。',
    85 => 'メールの送信に問題がありました。',
    86 => 'OpenIDのサーバがサインインを受け付けませんでした。',
    87 => 'OpenIDのサインイン処理をユーザーが取り消しました。',
...
$LANG_ACCESS = array(
    ...
    'permmsg' => '注意: メンバーとはすべてのサインインしているサイトのメンバーで、ゲストユーザーはサインインせずにアクセスしているすべての利用者です。',
...
$LANG_confignames['Core'] = array(
    ...
    'github_login' => 'GitHubのOAuthサインインを有効にする',
    ...
    'lastlogin' => '最終のサインインを記録する',
    'num_search_results' => '表示件数のデフォルト',
    'loginrequired' => 'すべてにサインインを必要とする',
    'submitloginrequired' => '投稿にサインインを必要とする',
    'commentsloginrequired' => 'コメント投稿にサインインを必要とする',
    'statsloginrequired' => '統計の参照にサインインを必要とする',
    'searchloginrequired' => '検索にサインインを必要とする',
    'profileloginrequired' => 'プロフィールの表示にサインインを必要とする',
    'emailuserloginrequired' => 'メールの送信にサインインを必要とする',
    'emailstoryloginrequired' => '記事のメール送信にサインインを必要とする',
    'directoryloginrequired' => '記事の一覧表示にサインインを必要とする',
    ...
    'login_attempts' => 'サインイン試行最大回数',
    'login_speedlimit' => 'サインイン試行制限間隔',
